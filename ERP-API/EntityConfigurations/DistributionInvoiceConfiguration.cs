...
{
    public class DistributionInvoiceConfiguration : IEntityTypeConfiguration<DistributionInvoice>
    {
        public void Configure(EntityTypeBuilder<DistributionInvoice> builder)
        {
            ...
            builder.Property(e => e.StatementId).HasDefaultValueSql("((0))");

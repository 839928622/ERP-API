...
{
    public class DistributionInvoiceDetailConfiguration : IEntityTypeConfiguration<DistributionInvoiceDetail
    >
    {
        public void Configure(EntityTypeBuilder<DistributionInvoiceDetail> builder)
        {
            ...
            builder.Property(e => e.InvoiceId).HasComment("DistributionInvoice表Id");

...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CatagoryParams>(entity =>
            {
            ...
            modelBuilder.Entity<CrawlerRequest>(entity =>
            {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.Name, e.Type, e.Status, e.EmployeesNum, e.Telphone, e.SalesId, e.PayMethod, e.CreditDays, e.BranchId, e.PayType })
                ...
                entity.Property(e => e.ConfirmLevel)
                    .HasDefaultValueSql("((5))")
                    .HasComment("审核下单level");

                entity.Property(e => e.Credit).HasComment("信用额度");

                entity.Property(e => e.CreditDays).HasComment("账期");
                ...
                entity.Property(e => e.IsBudget).HasComment("是否启用预算管理");

                entity.Property(e => e.IsBuyOutCounter).HasComment("是否可以买专柜以外的商品");

                entity.Property(e => e.IsComfirmOrder).HasComment("是否启用审核下单");

                entity.Property(e => e.IsCounter).HasComment("是否启用专柜");

                entity.Property(e => e.IsDisable).HasDefaultValueSql("((0))");

                entity.Property(e => e.IsMultiAccount)
                    .IsRequired()
                    .HasDefaultValueSql("((1))")
                    .HasComment("是否启用多账号");

                entity.Property(e => e.IsOrdering).HasComment("1:开启连续下单状态");

                entity.Property(e => e.IsStoreManager).HasComment("是否启用库存管理");
                ...
                entity.Property(e => e.OrderPrintNum)
                ...
                entity.Property(e => e.SalesId).HasComment("默认销售员");

                entity.Property(e => e.ServiceId).HasComment("客服");
                ...
                entity.Property(e => e.StatementManId).HasComment("对账员");
            ...
            modelBuilder.Entity<CustomerBalanceLog>(entity =>
            {
                entity.HasComment("客户余额日志");
                ...
                entity.Property(e => e.CreationId).HasComment("创建人");
                ...
                entity.Property(e => e.DeptId).HasComment("部门编号");

                entity.Property(e => e.DeptName)
                    .HasMaxLength(200)
                    .HasComment("部门名称");

                entity.Property(e => e.Direction).HasComment("1、增加 2、减少");

                entity.Property(e => e.RelationId).HasComment("关联订单编号");

                entity.Property(e => e.Remark)
                    .HasMaxLength(200)
                    .HasComment("备注");

                entity.Property(e => e.UserId).HasComment("联系人编号");
            ...
            modelBuilder.Entity<Dept>(entity =>
            {
                ...
                entity.Property(e => e.IsSepareOrder).HasComment("是否独立下单");

                entity.Property(e => e.IsSepareSettle).HasComment("是否独立结算");
            ...
            modelBuilder.Entity<DeptTemp>(entity =>
            {
                entity.Property(e => e.Balance).HasColumnType("money");
            ...
            modelBuilder.Entity<DistributionCustomerInvoice>(entity =>
            {
                entity.Property(e => e.BranchId).HasComment("开票方，即销方");
                ...
                entity.Property(e => e.DeliveryType).HasComment("配送方式");
                ...
                entity.Property(e => e.InvoiceType).HasComment("发票类型");
                ...
                entity.Property(e => e.LinkManId).HasComment("联系人编号");
                ...
                entity.Property(e => e.UserId).HasComment("开票操作人");
            });
            ...
            modelBuilder.Entity<DistributionInvoice>(entity =>
            {
                ...
                entity.Property(e => e.StatementId).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<DistributionInvoiceDetail>(entity =>
            {
                entity.Property(e => e.Amount)
                    .HasColumnType("money")
                    .HasComment("金额");
                ...
                entity.Property(e => e.InvoiceId).HasComment("DistributionInvoice表Id");
            ...
            modelBuilder.Entity<DistributionReceiveInvoice>(entity =>
            {
                ...
                entity.Property(e => e.BranchId).HasComment("购方");
                ...
                entity.Property(e => e.ChildBranchId).HasComment("销方，即下一级公司");
                ...
                entity.Property(e => e.StatementId).HasComment("对账单Id");
            ...
            modelBuilder.Entity<Franchisee>(entity =>
            {
                ...
                entity.Property(e => e.CompanyArea)
                    .IsRequired()
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasComment("公司地址区县");
                ...
                entity.Property(e => e.ContractWay)
                    .IsRequired()
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasComment("联系方式");
            ...
            modelBuilder.Entity<Goods>(entity =>
            {
                ...
                entity.Property(e => e.BranchId).HasComment("0：共有商品");
                ...
                entity.Property(e => e.DataSource).HasComment("是否抓取/下载");
                ...
                entity.Property(e => e.ParentId).HasComment(">1 说明是子商品，0：普通商品，1：母商品");
                ...
                entity.Property(e => e.Recommend).HasComment("推荐度");

                entity.Property(e => e.RecommendDate)
                    .HasColumnType("datetime")
                    .HasDefaultValueSql("(((1900)-(1))-(1))");

                entity.Property(e => e.SaleCount).HasComment("销售次数，每日集中计算");

                entity.Property(e => e.SaleNumber).HasComment("销售数量，每日集中计算");
            ...
            modelBuilder.Entity<GoodsCaptcha>(entity =>
            {
            ...
            modelBuilder.Entity<GoodsCategory>(entity =>
            {
                ...
                entity.Property(e => e.GoodsType).HasComment("商品类目");
                ...
                entity.Property(e => e.Tenant).HasComment("租户Id");
            ...
            modelBuilder.Entity<GoodsTypePrivateInfo>(entity =>
            {
                entity.HasIndex(e => new { e.TypeId, e.BranchId })
            ...
            modelBuilder.Entity<GoodsTypeUpdate>(entity =>
            {
            ...
            modelBuilder.Entity<GroupOrderStatement>(entity =>
            {
                entity.Property(e => e.ChargeOff).HasColumnType("money");
            ...
            modelBuilder.Entity<GroupPay>(entity =>
            {
                entity.Property(e => e.ChargeOff).HasColumnType("money");
            ...
            modelBuilder.Entity<IAnalysis>(entity =>
            {
                entity.ToTable("I_Analysis");
